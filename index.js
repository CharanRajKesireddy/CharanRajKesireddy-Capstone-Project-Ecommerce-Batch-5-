...
const collection  = require('./models/adding_Product.js');
...
app.get('/addingProduct',(req,res)=>{
    collection.find({ product_Name:"products",Description:"Description",category:"category",Expire_Date:"Expire_Date",UnitsInStock:"UnitsInStock"},function(err,docs){
        if(err || docs==null)
        {
